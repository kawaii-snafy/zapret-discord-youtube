...
--filter-udp=64000-65535 --ipset="%LISTS%ipset-cloudflare.txt" --dpi-desync=syndata --new ^
--filter-tcp=8000-9000 --ipset="%LISTS%ipset-cloudflare.txt" --dpi-desync=syndata
